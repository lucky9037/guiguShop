<template>
  <div class="shop-header">
    <nav
      class="shop-nav"
      :style='{backgroundImage:`url(${infos.bgImg})`}'
    >
      <a
        class="back"
        @click="$router.back()"
    ...
    <div class="shop-content">
      ...
      >
        ...
        <p class="shop-notice">{{infos.bulletin}}</p>
      </div>
    </div>
    <div
    ...
    >
      <div class="discounts-left">
        <div
          class="activity"
          :class="supportClasses[infos.supports[0].type]"
        >
          <span class="content-tag">
            <span class="mini-tag">{{infos.supports[0].name}}</span>
          </span>
          <span class="activity-content">{{infos.supports[0].content}}</span>
        </div>
      </div>
      ...
      >
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li
              class="activity-item"
              v-for="(suppose,index) in infos.supports"
              :key="index"
              :class="supportClasses[suppose.type]"
            >
              <span class="content-tag">
                <span class="mini-tag">{{suppose.name}}</span>
              </span>
              <span class="activity-content">{{suppose.content}}</span>
            </li>
          </ul>
          <div
...
export default {
  ...
  data () {
    return {
      ...
      isSuppose: false,  //优惠活动
      isShopShow: false,//商品信息
    };
  },
  mounted () {
